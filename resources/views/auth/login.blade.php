...
<div class="screen-1">
    ...
    <div class="email">
        ...
        <div class="sec-2">
            ...
            <input type="email" id="email" @error('email') is-invalid @enderror name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Username@gmail.com" autofocus/>
            @error('email')
    ...
    <div class="password">
        ...
        <div class="sec-2">
            ...
            <input id="password" type="password" class="pas @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="············"/>
            @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
